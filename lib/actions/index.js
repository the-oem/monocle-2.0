...
export const fetchLatLng = (location) => {
  return dispatch => {
    ...
    fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${location}&key=AIzaSyDaHFU4uLwMEaWG6I-Yp1geicUEqxCzGsk`)
      .then(response => {
      ...
      .then(parsedResults => {
        ...
        const latLngObj = Object.assign({}, {
          latitude: parsedResults.results[0].geometry.location.lat,
          longitude: parsedResults.results[0].geometry.location.lng,
        });
